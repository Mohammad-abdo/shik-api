...
function buildSheikhMobileSwaggerSpec() {
  return {
    ...
    tags: [
      ...
      { name: 'Upload', description: 'Upload image / intro video for sheikh profile' },
      { name: 'Stats', description: 'Quick counts (students, today sessions) for dashboard cards' },
      ...
      { name: 'Schedules', description: 'Manage my schedules / appointments (المواعيد) — pending admin approval after changes' },
    ...
    paths: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  required: ['name', 'email', 'password', 'confirmPassword', 'experience', 'specialties'],
                  properties: {
                    ...
                    experience: { type: 'integer', example: 5, description: 'سنوات الخبرة (مطلوب)' },
                    specialties: { type: 'array', items: { type: 'string' }, example: ['tajweed', 'memorization'], description: 'المهارات (مطلوب)' },
                    specialtiesAr: { type: 'array', items: { type: 'string' }, example: ['تجويد', 'حفظ'], description: 'المهارات بالعربية (اختياري)' },
                    bio: { type: 'string', example: 'Certified Quran teacher', description: 'السيرة بالإنجليزية (اختياري)' },
                    bioAr: { type: 'string', example: 'شيخ قرآن معتمد', description: 'السيرة بالعربية (اختياري)' },
                    readingType: { type: 'string', example: 'HAFS', description: 'نوع القراءة (اختياري)' },
                    readingTypeAr: { type: 'string', example: 'حفص', description: 'نوع القراءة بالعربية (اختياري)' },
                  },
                },
              },
            },
      ...
      '/upload/image': {
        post: {
          tags: ['Upload'],
          summary: 'Upload sheikh profile image',
          description: 'Upload image file (max 15 MB). Returns URL to use in PUT /profile `image` field.',
          security: bearerAuth,
          requestBody: {
            required: true,
            content: {
          ...
          responses: {
            201: {
              ...
              content: {
                'application/json': {
                  example: { success: true, url: '/uploads/images/abc123.webp' },
                },
              },
            },
      ...
      '/upload/video': {
        post: {
          tags: ['Upload'],
          summary: 'Upload sheikh intro video',
          description: 'Upload video file (max 150 MB). Returns URL to use in PUT /profile `introVideoUrl` field.',
          security: bearerAuth,
          requestBody: {
            required: true,
            content: {
          ...
          responses: {
            201: {
              ...
              content: {
                'application/json': {
                  example: { success: true, url: '/uploads/videos/xyz789.mp4' },
                },
              },
            },
            400: { description: 'No file provided' },
      ...
      '/stats/students-count': {
        get: {
          tags: ['Stats'],
          summary: 'Get count of my students (total + active)',
          description: 'Returns quick counts for dashboard cards — total students who ever subscribed and currently active students.',
          security: bearerAuth,
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  example: {
                    success: true,
                    data: { totalStudents: 12, activeStudents: 5 },
                  },
                },
              },
            },
      ...
      '/stats/today-sessions-count': {
        get: {
          tags: ['Stats'],
          summary: "Get count of today's sessions (total, completed, pending, cancelled)",
          description: "Returns quick counts for today's session dashboard card.",
          security: bearerAuth,
          responses: {
            200: {
              description: 'Today sessions count',
              content: {
                'application/json': {
                  example: {
                    success: true,
                    data: { total: 7, completed: 3, pending: 3, cancelled: 1 },
                  },
                },
              },
            },
      ...
      '/my-schedules': {
        get: {
          tags: ['Schedules'],
          summary: 'Get my schedules (all weekly time slots)',
          description: 'Returns all schedule slots for the authenticated sheikh, including inactive ones.',
          security: bearerAuth,
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  example: {
                    ...
                    total: 3,
                    schedules: [
                      { id: 'schedule-uuid-1', dayOfWeek: 0, dayName: 'Sunday', startTime: '09:00', endTime: '12:00', isActive: true },
                      { id: 'schedule-uuid-2', dayOfWeek: 2, dayName: 'Tuesday', startTime: '14:00', endTime: '18:00', isActive: true },
                      { id: 'schedule-uuid-3', dayOfWeek: 4, dayName: 'Thursday', startTime: '10:00', endTime: '13:00', isActive: true },
                    ],
                  },
                },
              },
        ...
        post: {
          tags: ['Schedules'],
          summary: 'Add schedule slots (single or multiple)',
          description: 'Add one or more weekly time slots. After adding, the profile goes to **pending admin approval**.\n\nSend a single slot object OR wrap multiple in a `slots` array.\n\n**dayOfWeek:** 0=Sunday, 1=Monday, 2=Tuesday, 3=Wednesday, 4=Thursday, 5=Friday, 6=Saturday.',
          security: bearerAuth,
          requestBody: {
            required: true,
            content: {
              'application/json': {
                  ...
                  oneOf: [
                    {
                      ...
                      properties: {
                        dayOfWeek: { type: 'integer', minimum: 0, maximum: 6, example: 0, description: '0=Sunday … 6=Saturday' },
                        startTime: { type: 'string', example: '09:00', description: 'HH:MM format' },
                        endTime: { type: 'string', example: '12:00', description: 'HH:MM format' },
                      },
                    },
                    {
                      type: 'object',
                      ...
                      properties: {
                        slots: {
                          ...
                          items: {
                            ...
                            required: ['dayOfWeek', 'startTime', 'endTime'],
                            properties: {
                              dayOfWeek: { type: 'integer', minimum: 0, maximum: 6, example: 2 },
                ...
                examples: {
                  singleSlot: {
                    ...
                    value: { dayOfWeek: 0, startTime: '09:00', endTime: '12:00' },
                  },
                  multipleSlots: {
                    summary: 'Add multiple slots',
                    value: {
                      slots: [
          ...
          responses: {
            201: {
              description: 'Schedules created — pending admin approval',
              content: {
                'application/json': {
                  example: {
                    success: true,
                    ...
                    createdCount: 2,
                    schedules: [
                      { id: 'uuid', dayOfWeek: 0, startTime: '09:00', endTime: '12:00', isActive: true },
                      { id: 'uuid', dayOfWeek: 2, startTime: '14:00', endTime: '18:00', isActive: true },
                    ],
                  },
                },
              },
            },
            400: { description: 'Validation error (missing fields, invalid time format)' },
            409: { description: 'Overlapping schedule slot' },
          },
        },
      },
      ...
      '/my-schedules/{scheduleId}': {
        put: {
          ...
          description: 'Update an existing schedule slot. All fields are optional — send only fields to change. After editing, the profile goes to **pending admin approval**.',
          security: bearerAuth,
          parameters: [
            { name: 'scheduleId', in: 'path', required: true, schema: { type: 'string' }, description: 'Schedule ID (from GET /my-schedules)' },
          ],
          requestBody: {
            required: true,
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    startTime: { type: 'string', example: '10:00', description: 'HH:MM format' },
                    endTime: { type: 'string', example: '14:00', description: 'HH:MM format' },
                  },
                },
              },
            },
          ...
          responses: {
            200: {
              description: 'Schedule updated — pending admin approval',
              content: {
                'application/json': {
                  example: {
                    success: true,
                    message: 'Schedule updated — pending admin approval',
                    schedule: { id: 'uuid', dayOfWeek: 1, startTime: '10:00', endTime: '14:00', isActive: true },
                  },
                },
              },
            },
        ...
        delete: {
          ...
          description: 'Delete a schedule slot permanently. After deleting, the profile goes to **pending admin approval**.',
          security: bearerAuth,
          parameters: [
            { name: 'scheduleId', in: 'path', required: true, schema: { type: 'string' }, description: 'Schedule ID (from GET /my-schedules)' },
          ],
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  example: { success: true, message: 'Schedule deleted — pending admin approval' },
                },
              },
            },
            404: { description: 'Schedule not found' },
