...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: '0 = Sunday, 1 = Monday, ..., 6 = Saturday' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '09:00', description: 'HH:mm format' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '17:00', description: 'HH:mm format' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, {
