...
export declare class AdminService {
    ...
    getAllTeachers(page?: number, limit?: number, isApproved?: boolean): Promise<{
        teachers: ({
            user: {
                id: string;
                email: string;
    ...
    createUser(dto: CreateUserDto, adminId: string): Promise<{
        userRoles: ({
            role: {
                id: string;
                createdAt: Date;
    ...
    createTeacher(dto: CreateTeacherDto, adminId: string): Promise<{
        user: {
            id: string;
            email: string;
            phone: string;
    ...
    updateUser(userId: string, dto: UpdateUserDto, adminId: string): Promise<{
        userRoles: ({
            role: {
                id: string;
                createdAt: Date;
    ...
    updateTeacher(teacherId: string, dto: UpdateTeacherDto, adminId: string): Promise<{
        user: {
            id: string;
            email: string;
            firstName: string;
    ...
    getAllTeacherWallets(page?: number, limit?: number, search?: string): Promise<{
        wallets: ({
            payoutRequests: {
                id: string;
                status: import(".prisma/client").$Enums.PayoutStatus;
    ...
    getTeacherWallet(teacherId: string): Promise<{
        payoutRequests: {
            id: string;
            status: import(".prisma/client").$Enums.PayoutStatus;
            createdAt: Date;
    ...
    sendMoneyToTeacher(teacherId: string, amount: number, paymentMethod: string, description: string, adminId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        teacherId: string;
    ...
    disableWallet(teacherId: string): Promise<{
        teacher: {
            user: {
                id: string;
                email: string;
    ...
    enableWallet(teacherId: string): Promise<{
        teacher: {
            user: {
                id: string;
                email: string;
    ...
    forceCancelBooking(bookingId: string, adminId: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.BookingStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    forceConfirmBooking(bookingId: string, adminId: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.BookingStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    getPrincipalReport(startDate?: Date, endDate?: Date): Promise<{
        summary: {
            totalUsers: number;
            totalTeachers: number;
    ...
    getTeacherReport(startDate?: Date, endDate?: Date, teacherId?: string): Promise<{
        summary: {
            totalTeachers: number;
            activeTeachers: number;
            totalBookings: number;
    ...
    getStudentReport(startDate?: Date, endDate?: Date, studentId?: string): Promise<{
        summary: {
            totalStudents: number;
    ...
    getBookingTrends(startDate: Date, endDate: Date): Promise<{
        total: number;
        completed: number;
        cancelled: number;
        date: string;
    }[]>;
    sendGlobalNotification(adminId: string, title: string, message: string): Promise<{
        sent: number;
    }>;
    sendNotificationToUsers(adminId: string, userIds: string[], title: string, message: string): Promise<{
        sent: number;
    }>;
    ...
    getAllStudentWallets(page?: number, limit?: number, search?: string): Promise<{
        wallets: ({
            transactions: {
                id: string;
                createdAt: Date;
    ...
    depositToStudentWallet(dto: DepositToWalletDto, adminId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        balance: number;
    ...
    withdrawFromStudentWallet(dto: WithdrawFromWalletDto, adminId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        balance: number;
    ...
    processStudentPayment(dto: ProcessPaymentDto, adminId: string): Promise<{
        wallet: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    getStudentWalletTransactions(walletId: string, page?: number, limit?: number): Promise<{
        transactions: {
            id: string;
            createdAt: Date;
            description: string;
