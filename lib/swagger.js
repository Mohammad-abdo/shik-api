    ...
    return [
      {
        ...
        sheikhs: [
          { id: 'teacher-uuid', name: 'Ahmed Hassan', image: null, specialization: 'Tajweed', rating: 4.9 },
        ],
      },
    ];
  }
...
function inferMobileOperationDescription(routePath, method) {
  ...
  if (p.includes('/v1/student/my-courses') && m === 'get') return 'Returns all courses the student is enrolled in, with progress, rating, and sheikh details for each course.';
...
function inferMobileOperationSummary(routePath, method) {
  ...
  if (p.includes('/v1/student/my-courses') && m === 'get') return 'My Enrolled Courses (Student)';
